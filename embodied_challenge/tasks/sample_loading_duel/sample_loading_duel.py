...
from embodichain.lab.gym.envs.tasks.tableware.sample_loading_duel.action_bank import (
    SampleLoadingDuelActionBank,
)

__all__ = ["SampleLoadingDuelEnv", "SampleLoadingDuelAgentEnv"]


@register_env("SampleLoadingDuel-v1", max_episode_steps=600)
class SampleLoadingDuelEnv(EmbodiedEnv):
    ...
    def create_demo_action_list(self, *args, **kwargs):
        ...
        if getattr(self, "action_config") is not None:
            self._init_action_bank(SampleLoadingDuelActionBank, self.action_config)
...
@register_env("SampleLoadingDuelAgent-v1", max_episode_steps=600)
class SampleLoadingDuelAgentEnv(BaseAgentEnv, SampleLoadingDuelEnv):
    def __init__(self, cfg: EmbodiedEnvCfg = None, **kwargs):
        super().__init__(cfg, **kwargs)
